...
(function () {
	...
	callWithJQuery(function ($) {
		$.fn.gtHeatmap = function (scope, opts) {
			var colorScaleGenerator, heatmapper, i, x, j, l, n, numCols, numRows, ref, ref1, ref2, _finalAggregatorsNameMap,
...
(function () {
	...
	var pivotTableRenderer = function (pivotData, opts) {
		var aggregator, c, colAttrs, colKey, colKeys, defaults, getClickHandler, getMouseEnterHandler, getMouseLeaveHandler,
			getMouseMoveHandler, i, j, r, result,
