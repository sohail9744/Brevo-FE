/*
 * canvgWithoutSAP.js - Javascript SVG parser and renderer on Canvas
 * MIT Licensed
 * Gabe Lerner (gabelerner@gmail.com)
 * http://code.google.com/p/canvgWithoutSAP/
 *
...
(function(global, factory) {
	...
	if (typeof define !== 'undefined' && define.amd) {
		define('canvgWithoutSAPModule', ['rgbcolor', 'stackblur'], factory);
	}
	...
	global.canvgWithoutSAP = factory(global.RGBColor, global.stackBlur);

}(typeof window !== 'undefined' ? window : this, function(RGBColor, stackBlur) {

	// canvgWithoutSAP(target, s)
	...
	var canvgWithoutSAP = function(target, s, opts) {
		// no parameters
		if (target == null && s == null && opts == null) {
			...
			for (var i = 0; i < svgTags.length; i++) {
				...
				canvgWithoutSAP(c, div.innerHTML);
			}
			return;
		}
	...
	function build(opts) {
		...
		svg.init = function(ctx) {
			...
			svg.UniqueId = function() {
				uniqueId++;
				return 'canvgWithoutSAP' + uniqueId;
			};
			svg.Definitions = {};
			svg.Styles = {};
	...
	if (typeof CanvasRenderingContext2D != 'undefined') {
		CanvasRenderingContext2D.prototype.drawSvg = function(s, dx, dy, dw, dh,
			...
			canvgWithoutSAP(this.canvas, s, cOpts);
		}
	}

	return canvgWithoutSAP;
