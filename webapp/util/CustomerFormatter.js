jQuery.sap.declare("dynamicCards.util.CustomerFormatter");
...
var Format = sap.viz.ui5.api.env.Format;
    dynamicCards.util.CustomerFormatter =  {
        ...
        registerCustomFormat: function() {
            ...
            chartFormatter.registerCustomFormatter(this.FIORI_LABEL_SHORTFORMAT_2, 
				...
				var selectedFormat = dynamicCards.util.drawChartFormatter.measureFormat;
				var decimalValue = dynamicCards.util.drawChartFormatter.decimalValue;
				var decimalPlaces;
				if(decimalValue){
